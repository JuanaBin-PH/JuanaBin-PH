...
- **Deliverable 1** — Stellar Wallet Provisioning + JBIN Reward Token (Testnet)
- **Deliverable 2** — Segregate-to-Earn Logic Engine
- **Deliverable 3** — Pilot Community Demo + Admin Dashboard
