...
| 7 | Confirm the "30-day" label against the 32-day Aug 25 – Sep 25 window — see "Reconcile before submitting" | — |
...
1. **Calendar length vs. the "30-day" label.** Aug 25 – Sep 25, 2026 is **32 calendar days**, yet the program name and every document in this repository call it a 30-day sprint. The date conflict with the original submission document is now resolved — [docs/](docs/) uses Aug 25 – Sep 25, 2026 throughout, including the weekly gates, the sprint chart, the signature block in [docs/08-team-information.md](docs/08-team-information.md), the constraints in [docs/06-budget-justification.md](docs/06-budget-justification.md), and the SCF forum update dates (Aug 31, Sep 7, Sep 14, Sep 21, plus the Sep 25 completion report). What remains is the label: if SCF requires exactly 30 calendar days, either move the close to Sep 23 or state the "4 working weeks + submission buffer" structure explicitly in the application.
