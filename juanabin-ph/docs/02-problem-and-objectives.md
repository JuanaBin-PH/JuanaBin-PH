...
The Philippines generates approximately **15 million tonnes** of solid waste per year, of which roughly **9 million tonnes** are mismanaged — dumped, burned, or left uncollected. Despite the Ecological Solid Waste Management Act (RA 9003), household-level waste segregation compliance remains critically low across Metro Manila barangays. In August 2026, three structural barriers continue to drive this failure:
...
| 3 | **Financial Exclusion** | 51 million Filipinos are unbanked as of 2026. Reward programs requiring bank accounts, e-wallets, or government IDs exclude the communities that most need economic support from waste recovery activities. |
...
| O4 | Demonstrate a working pilot with real households earning JBIN tokens for waste segregation | **Deliverable 3** Pilot Demo + Community Dashboard |
